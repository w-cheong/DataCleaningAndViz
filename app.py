...
def header_and_whitespace_cleaning(df):
...
def main():
    ...
    df = header_and_whitespace_cleaning(df)

    # standardize text case for Validated
    validated_mapping = {'N': 'No',
                        'NO' : 'No',
                        'No': 'No',
                        'Y': 'Yes',
                        'YES': 'Yes',
